...
class IdentiteScreen extends ConsumerWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                if (patient.antecedents.isNotEmpty) ...[
                  Text('Antécédents & Maladies', style: Theme.of(context).textTheme.headlineMedium),
                  const SizedBox(height: 16),
                  _buildChipList(context, patient.antecedents, AppTheme.primaryBlueLight, Icons.history_edu_rounded),
                  const SizedBox(height: 32),
                ],
                if (patient.allergies.isNotEmpty) ...[
                  Text('Allergies', style: Theme.of(context).textTheme.headlineMedium),
                  const SizedBox(height: 16),
                  _buildChipList(context, patient.allergies, AppTheme.emergencyRedLight, Icons.do_not_disturb_on_rounded),
                  const SizedBox(height: 32),
                ],
  ...
  Widget _buildChipList(BuildContext context, String data, Color color, IconData icon) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: AppTheme.premiumShadow(color.withValues(alpha: 0.1)),
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                item,
                style: TextStyle(
                  color: color == AppTheme.primaryBlueLight ? AppTheme.primaryBlueDark : AppTheme.emergencyRedDark,
