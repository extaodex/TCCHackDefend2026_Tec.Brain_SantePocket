...
class EncryptionService {
  ...
  /// Dérive une clé de taille spécifiée à partir d'un mot de passe et d'un sel (PBKDF2-like).
  ...
  /// Dérive le mot de passe WiFi WPA2 à partir de l'UUID.
  ...
  /// Dérive une clé AES-256 à partir de l'UUID.
  ...
  static Uint8List decrypt(Uint8List encryptedData, Uint8List keyBytes) {
    if (encryptedData.length < 16) {
      throw ArgumentError("Données chiffrées invalides.");
    }
