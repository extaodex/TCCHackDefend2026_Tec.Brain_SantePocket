...
/// Encodage gros-boutiste (Big-Endian).
...
/// Écrit des données chiffrées sur le socket. Si la clé est nulle, écrit en clair.
...
/// Lit des données chiffrées depuis le reader. Si la clé est nulle, décode en clair.
